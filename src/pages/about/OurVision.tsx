const OurVision: React.FC = () => {
  return (
    <div className="grid grid-cols-3 bg-[#808CFD]">
      <div className="container flex flex-col justify-between px-5 py-8 col-span-2">
        <div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="max-w-[813px] paragraph-2">
      ...
      <div className="flex items-center justify-end ">
        <img src="../../../public/about/Image.jpg" alt="" className="w-full h-full  object-cover"/>
      </div>
    </div>
  );
};
